...
INSERT INTO `categoria` VALUES (1,'Automotriz','#00FFFF'),(2,'Herramientas de medición','#FF00FF'),(3,'Limpieza','#4d7bac'),(4,'Construcción','#FF8000'),(5,'Herramientas de golpe','#00FF00'),(6,'Jardineria','#7cbb48'),(7,'Esmaltes','#e1bbdd'),(10,'Cerrajería','#ff00ff');
...
INSERT INTO `empresa` VALUES (1,'H&T Trading E.I.R.L','COMERCIO','EMPRESA INDIVIDUAL DE RESP. LTDA','ventas@hyt-trading.com','745-6214','5fd2b722fd3964dcfa720bf01e4b78d2.png','LIMA','LIMA','COMAS','Av. Jamaica Mza.M Lote 3 Urb. San Agustín 2da Etapa, Comas.');
...
INSERT INTO `productos` VALUES ('P00001','Producto 1','A',NULL,NULL,1),('P00002','Producto 2','A',NULL,NULL,2),('P00003','Product 3','A',NULL,NULL,1);
...
-- Dump completed on 2022-11-14 23:45:02
