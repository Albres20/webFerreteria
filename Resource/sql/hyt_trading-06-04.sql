...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-04-2022 a las 05:17:02
...
INSERT INTO `productos` (`productos_id`, `productos_codigo`, `productos_nombre`, `productos_marca`, `productos_preccompra`, `productos_precventa`, `productos_cantidad`, `productos_imagen`, `productos_fecha`, `productos_idcategorias`) VALUES
(1, 'HM-64564', 'CINTA MÉTRICA PROFESSIONAL 8 MTS', 'IRWIN', 45.90, 55.90, 15, '', '2022-04-07 02:24:34', 2),
(2, 'HM-30680', 'CINTA MÉTRICA GLOBAL PLUS 3 MTS 1/2 PULG', 'STANLEY HERRAMIENTA MANUAL', 48.00, 58.00, 10, '', '2022-04-07 02:26:30', 2),
(3, 'AU-78023', 'JUEGO EXTRACTOR DE TORNILLOS STANLEY', 'STANLEY HERRAMIENTA MANUAL', 26.50, 35.90, 9, '', '2022-04-07 02:33:19', 1);
...
ALTER TABLE `productos`
  ...
  ADD KEY `id_categoria_producto` (`productos_idcategorias`);
