            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Historial de Compras</h4>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-sm-8">
                                    <a href="nuevaCompra" role="button" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i> Nueva Compra</a>
                                </div>
                                <div class="col-sm-4">
                                ...
                                <table class="table table-striped table-centered w-100 dt-responsive nowrap" id="products-datatable">
                                    <thead class="table-dark">
                                        <tr>
                                            ...
                                            <th data-sort="" class="all">N° Compra</th>
                                            <th data-sort="">Documento</th>
                                            <th data-sort="">Proveedor</th>
