...
CREATE TABLE `producto_det` (
  ...
  CONSTRAINT `fk_Producto_det_productos1` FOREIGN KEY (`prd_codigo`) REFERENCES `productos` (`prd_codigo`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `producto_det` VALUES (2,12.00,18.00,50,'EWRWR','2022-11-25 22:34:03','P00006'),(6,10.00,10.00,17,'ESCOBON','2022-11-27 20:43:33','P00008');
...
INSERT INTO `productos` VALUES ('P00001','Producto 12','A',NULL,'',1),('P00002','Producto 2','A',NULL,NULL,2),('P00003','Product 3','A',NULL,NULL,1),('P00004','Producto 4','A',NULL,NULL,3),('P00005','CINTA METRICA','A',NULL,'937f26ce9707ccf785f076ce8e67631a.jpg',2),('P00006','CAÑO DE JARDIN','A','2022-11-25 22:34:03','8579d67401f0bb305921b13d3c2fb9b1.png',6),('P00008','ESCOBA GRANDE','A','2022-11-27 16:51:19','f3a1ff1c6e6e5d615bf5f62aa113e7c3.jpg',3);
...
INSERT INTO `usuario` VALUES (001,'admin','$2y$10$MJD414C1powe7UvzDNb3geLIbMOXa9cyps/RmkrQ4tbAkYLJppprm','LUIS RAMIREZ',NULL,NULL,'A','2022-12-14 17:12:33',NULL,1),(002,'cajero1','1234','GUSTAVO HUERTA',NULL,NULL,'A',NULL,NULL,2),(004,'paolo','$2y$10$JFewOgvTyQHT3b4vypyaiOVcclNm28PZeB.oRMB7Omf1InDKv7kfi','paolo coronado','dsada@gmail.com','','A','2022-12-13 17:11:32','2022-11-13 16:25:59',2),(005,'moises','$2y$10$L5uo.Hgr7GMDoJ9cBiaF7OEjJb2pAUTdNWhEpKX7LItIfvPA8FnJG','CRISTHOFER VENTURA','cristhoferventurav@gmail.com','139f072a81f00f4a8b28f0569371bb5c.jpg','A','2022-12-13 17:09:24','2022-11-13 22:34:58',1),(006,'juan carrasco','$2y$10$mqz0S98pdp8h51ghexnkFecHNJiQ0otYHYxELhsUS9hYDCbk1tNE.','JUAN CARRASCO GUZMAN','juanpa@gmail.com','','A','2022-12-13 17:13:09','2022-11-25 17:53:02',3);
...
INSERT INTO `ventas` VALUES ('0000000001',14.00,'2022-12-12 18:41:50','A',002,5);
...
CREATE TABLE `ventas_det` (
  ...
  `vta_numped` char(10) DEFAULT NULL,
  `prd_codigo` char(6) NOT NULL,
...
INSERT INTO `ventas_det` VALUES (1,'0000000001','P00001',7.00,2,14.00,'2022-12-12 18:41:50','A'),(7,'0000000001','P00006',18.00,7,126.00,'2022-12-13 00:12:44','A'),(8,NULL,'P00006',18.00,7,126.00,'2022-12-13 00:13:22','A'),(9,'0000000001','P00005',NULL,4,0.00,'2022-12-13 00:14:14','A'),(10,'0000000001','P00008',10.00,8,80.00,'2022-12-13 00:16:34','A'),(11,NULL,'P00008',10.00,2,20.00,'2022-12-13 00:18:48','A'),(12,NULL,'P00001',NULL,4,0.00,'2022-12-13 01:26:39','A'),(13,NULL,'P00006',18.00,5,90.00,'2022-12-14 17:18:24','A');
...
-- Dump completed on 2022-12-14 19:56:27
